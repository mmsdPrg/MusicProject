...
{
    [DbContext(typeof(DB_Music))]
    [Migration("20220927093245_mig1")]
    partial class mig1
    {
            ...
            modelBuilder.Entity("MusicProject.Models.MusicImage", b =>
                {
                    ...
                    b.HasIndex("AlbomOrMusicId");

                    b.ToTable("MusicImage");
                });

            modelBuilder.Entity("ArtistMusic", b =>
                {
                    b.HasOne("MusicProject.Models.Artist", null)
                        .WithMany()
                        .HasForeignKey("Artistsid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MusicProject.Models.Music", null)
                        .WithMany()
